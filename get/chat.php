...
if(isset($_GET['activerooms'])){
  foreach(db("select room_id,room_name,question_id,community_colour,community_name,room_account_unread_messages,room_account_latest_read_chat_id from activerooms()") as $r){ extract($r);?>
