...
extract(cdb("select account_id,community_language
                  , (select jsonb_agg(z) from (select account_id,account_derived_name,account_image_url,communicant_votes from account order by participant_latest_chat_at desc) z) accounts
