...
<head>
  ...
  <style>
    *:not(hr) { box-sizing: inherit; }
    ...
    .markdown { background: white; padding: 8px; font-size: 16px; border: 1px solid var(--colour-dark); border-radius: 3px; }
...
<body style="font-size: larger; background: var(--colour-light);">
  <header>
    <div>
