...
$$;
create function login2(uuid uuid) returns boolean language sql security definer set search_path=db,api,pg_temp as $$
...
$$;
create function login_community2(uuid uuid, cid integer) returns boolean language sql security definer set search_path=db,api,chat,pg_temp as $$
  select _error('invalid community')
...
$$;
--
create function login_room2(uuid uuid, rid integer) returns boolean language sql security definer set search_path=db,api,chat,pg_temp as $$
  --
