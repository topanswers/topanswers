...
switch($_POST['action']) {
  ...
  case 'change':
    ...
    exit;
  case 'new':
    $id=ccdb("select new2($1::integer,$2,$3,$4,$5,$6,$7)",$_POST['sanction'],$_POST['title'],$_POST['markdown'],$_POST['license'],isset($_POST['license-orlater'])?'t':'f',$_POST['codelicense'],isset($_POST['codelicense-orlater'])?'t':'f');
    if($id){
