...
<style>
  ...
  .markdown .tio .CodeMirror { height: auto; border: 1px solid rgb(var(--rgb-dark)); font-family: var(--monospace-font-family); border-radius: 3px; font-size: 90%; }
  .markdown .tio .CodeMirror-scroll { margin-bottom: -30px; }

  .dbfiddle { padding: 8px; background: rgb(var(--rgb-light)); border-radius: 3px; }
  .dbfiddle .CodeMirror { height: auto; border: 1px solid rgb(var(--rgb-dark)); font-family: var(--monospace-font-family); border-radius: 3px; font-size: 90%; }
