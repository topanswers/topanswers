...
select account_id
      ,community_id,community_name,community_display_name,community_my_power,community_code_language,room_id,community_tables_are_monospace,community_about_question_id,community_ask_button_text,community_banner_markdown
