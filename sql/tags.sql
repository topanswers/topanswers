...
--
--
create view tag with (security_barrier) as select tag_id,tag_name,tag_markdown,tag_question_count,tag_implies_id,tag_code_language from db.tag where community_id=get_community_id();
--
